...
import { deleteImage, fetchDataFromApi, profileEditData} from '../../utlis/api';
...
const onChangeDescription = (event)=>{
 ...
 if(formFields.description===''){
  ...
  profileEditData(`/api/blog/${context?.isOpenFullScreenPanel?.id}`,formFields,{withCredentials: true})
   .then((res)=>{
    console.log(res);
